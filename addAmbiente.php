...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    DatabaseConnection::addAmbiente($ambiente, $id);
...
<body>
    ...
    <div style="margin-top: 120px;margin-left: 500px;  padding-right:400px " >
        <div class="card  mx-auto mt-5">
            <div class="card-header">Adicionar Ambiente</div>
            <div class="card-body">
                <form method="post">

                     <div class="form-group">
                        <label for="exampleInputPassword1">Nome: </label>
                        <input class="form-control" id="exampleInputPassword1" name="ambiente" placeholder="">
                    </div>
